            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Whole Day Booking <span>/ Add Booking</span></h3>
                    </div>
                ...
                <div class="col-lg-12 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form action="<?= base_url('WholeDayBooking/Bookings') ?>" method="post" enctype='multipart/form-data'>
                            ...
                            <table class="table table-bordered data-table data-table-default">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url() ?>WholeDayBooking/editBooking/<?= $b->w_booking_id ?>"><i class="fa fa-pencil"></i></a>
                                            <a class="delete-confirm" href="<?= base_url() ?>WholeDayBooking/deleteBooking/<?= $b->w_booking_id ?>" ><i class="fa fa-trash" style="color:red;margin-left:10px;"></i></a></td>
