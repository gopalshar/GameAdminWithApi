            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Member <span>/ Add Member</span></h3>
                    </div>
                ...
                <div class="col-lg-12 col-12 mb-30">
                    <div class="box">
                        <div class="box-head d-flex justify-content-between">
                            ...
                            <a href="<?= base_url('Member/manageMembers') ?>" class="custom_design_btn">Members Detail</a>
                        </div>
                        <div class="result">
                            ...
                            <form action="<?= base_url('Member/addMember') ?>" method="post">
                                <div class="row mbn-20">
                                    ...
                                    <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Member Name</label>
                                        <input type="text" id="formLayoutUsername1" name="user_name" class="form-control" placeholder="Member Name" required>
                                    </div>
                                    
                                    
                                     <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Mobile Number</label>
                                        <input type="number" name="user_contact" class="form-control" placeholder="Mobile Number" required>
                                    </div>
                                    
                                     <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Email Address</label>
                                        <input type="email" id="formLayoutUsername1" name="user_email" class="form-control" placeholder="Email Address" required>
                                    </div>

                                    <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Enter Address</label>
                                        <input type="text" id="formLayoutUsername1" name="user_address" class="form-control" placeholder="Enter Address" required >
                                    </div>

                                     <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Registration Date</label>
                                        <input type="text" id="datepicker" name="user_reg_date" class="form-control input-date-single" placeholder="Registration Date" required>
                                    </div> 

                                    <div class="col-6 mb-20 ">
                                        <lable>Select Subscription Plan</lable>
                                        <select class="form-control" name="user_subscription_id">
                                            <option value="">Select Plan</option>
                                            <?php foreach ($sub as $s) : ?>
                                            <option value="<?= $s->sub_id ?>"><?= $s->sub_name.'   '.$s->sub_price_currency.''.$s->sub_price ?></option>
                                        <?php endforeach; ?>
