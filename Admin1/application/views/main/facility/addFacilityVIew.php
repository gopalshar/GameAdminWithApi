            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Facility <span>/ Add Facility</span></h3>
                    </div>
                ...
                <div class="col-lg-12 col-12 mb-30">
                    <div class="box">
                       <div class="box-head d-flex justify-content-between">
                        ...
                        <div class="box-body">
                            <form action="<?= base_url('Facility/addFacility') ?>" method="post" enctype='multipart/form-data'>
                                <div class="row mbn-20">

                                    <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Facility Name</label>
                                        <input type="text" id="formLayoutUsername1" name="facility_name" class="form-control" placeholder="Username" required>
                                    </div>
                                    <div class="col-1">
                                        <lable></lable>
                                        <img src="<?= base_url() ?>assets/images/avatar/avatar-1.jpg"  style="width:132px;margin-top:31px;" id="facility_image_preview" alt="">
                                       
                                        
                                    </div>
                                    <div class="col-5 mb-20">
                                        <label for="formLayoutEmail1">Facility Image</label>
                                        <input type="file" name="facility_image" id="facility_image" class="form-control" onchange="document.getElementById('facility_image_preview').src = window.URL.createObjectURL(this.files[0])" placeholder="Email" required>
                                    </div>
                                     <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Facility number</label>
                                        <input type="number" id="facility_numbers" class="form-control" placeholder="Number">
                                    </div>
                                    <div class="col-1"></div>
                                    <div class="col-5 mb-20">
                                        <label for="formLayoutEmail1">Facility  names</label>
                                     ...
                                     <div class="col-6 mb-20">
                                        ...
                                        <input type="text" id="formLayoutUsername1" name="facility_quantity" class="form-control" placeholder="Max Person Quantity">
                                    </div>
                                    <div class="col-6 mb-20">
                                        <label for="formLayoutMessage2">Facility Description</label>
                                        <textarea id="formLayoutMessage2" name="facility_spec" class="form-control" placeholder="Description"></textarea>
                                    </div>

                                    <div class="col-12 mb-20">
                                        <div class="row">
                                         <div class="col-2"><button type="button" id="add_addons" class="button button-primary"><i class="fa fa-plus"></i> Add</button></div>
                                         <div class="col-8" >
                                           <div id="containers">
                                     ...
                                     <div class="col-6 mb-20">
                                        ...
                                        <input type="text" id="formLayoutUsername1" name="facility_adon_person" class="form-control" placeholder="Adon Max Person">
                                    </div>
                                    <div class="col-6 mb-20">
                                        <label for="formLayoutEmail1">Hourly Price</label>
                                        <input type="text" id="formLayoutUsername1" name="facility_hour_price" class="form-control" placeholder="Hourly Price">
                                    </div>
