            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Booking <span>/ Manual Booking</span></h3>
                    </div>
                ...
                <div class="col-lg-12 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form action="<?= base_url('Booking/manualBooking') ?>" method="post" enctype='multipart/form-data'>
                                <div class="row mbn-20">
                                    ...
                                    <div class="col-6 mb-20">
                                     ...
                                     <div class="col-6 mb-20">
                                        ...
                                        <input type="number" name="booking_user_mobile" class="form-control" placeholder="Mobile Number" required>
                                    </div>
                                     ...
                                     <div class="col-6 mb-20">
                                        ...
                                        <select name="booking_facility_id" class="form-control" id="facility_id" required>
                                            ...
                                            <option value="<?= $u->facility_id ?>"><?= $u->facility_name ?></option>
                                        <?php endforeach;?>
                                        </select>
                                    </div>
                                     ...
                                     <div class="col-6 mb-20">
                                        ...
                                        <input type="text" id="datepicker_id" name="booking_date" class="form-control input-date-single" placeholder="Validity In Month">
                                         <label class="alert alert-danger" style="display: none;margin-top:5px;" id="block_error">Date is Blocked</label>
                                    </div> 
                            ...
                            <label style="color:red;display: none;margin-top:5px;" id="booking_error">Booking is not available in this time</label>
                                    ...
                                    <div class="col-6 mb-20">
                                        ...
                                        <input type="number" id="formLayoutMessage2" name="booking_persons" class="form-control" placeholder="Person" required>
                                    </div>
                                   
                                    <div class="col-6 mb-20">
                                        <lable>Addons</lable>
                                        <select class="form-control" name="booking_addons[]" multiple="true" required>
                                     ...
                                     <div class="col-6 mb-20">
                                        ...
                                        <input type="number" id="formLayoutMessage2" name="addi_person" class="form-control" placeholder="Additional Members" required >
                                    </div>
