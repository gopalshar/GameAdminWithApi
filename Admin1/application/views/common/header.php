<!doctype html>
<html class="no-js" lang="en" dir="lrt">
            ...
            <div class="container-fluid">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="header-logo col-auto">
                        <a href="<?= base_url() ?>">
                            <img width="34px" src="<?= base_url() ?>assets/images/icon1.png" alt="">
                           <!--  <img src="<?= base_url() ?>assets/images/logo/logo-light.png" class="logo-light" alt=""> -->
                        </a>
                            ...
                            <div class="col-auto">
                                ...
                                <ul class="header-notification-area">
                                    ...
                                    <li class="adomx-dropdown position-relative col-auto">
                                        <a class="toggle" href="#"><img class="lang-flag" src="<?= base_url() ?>assets/images/flags/flag-1.jpg" alt=""><i class="zmdi zmdi-caret-down drop-arrow"></i></a>

                                        <!-- Dropdown -->
                                        <ul class="adomx-dropdown-menu dropdown-menu-language">
                                            <li><a href="#"><img src="<?= base_url() ?>assets/images/flags/flag-1.jpg" alt=""> English</a></li>
                                            <li><a href="#"><img src="<?= base_url() ?>assets/images/flags/flag-2.jpg" alt=""> Japanese</a></li>
                                            <li><a href="#"><img src="<?= base_url() ?>assets/images/flags/flag-3.jpg" alt=""> Spanish </a></li>
                                            <li><a href="#"><img src="<?= base_url() ?>assets/images/flags/flag-4.jpg" alt=""> Germany</a></li>
                                        </ul>
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-mail">
                                            ...
                                            <div class="body custom-scroll">
                                                <ul>
                                                    <li>
                                                        <a href="#">
                                                            <div class="image"><img src="<?= base_url() ?>assets/images/avatar/avatar-2.jpg" alt=""></div>
                                                            <div class="content">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="image"><img src="<?= base_url() ?>assets/images/avatar/avatar-1.jpg" alt=""></div>
                                                            <div class="content">
                                    ...
                                    <li class="adomx-dropdown col-auto">
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-user">
                                            <div class="head">
                                                <h5 class="name"><a href="#"><?= $user_data->name ?></a></h5>
                                                <a class="mail" href="#"><?= $user_data->email ?></a>
                                            </div>
                                            <div class="body">
                                                <ul>
                                                    <li><a href="<?= base_url('Dashboard/AdminProfile') ?>"><i class="zmdi zmdi-account"></i>Profile</a></li>
                                                    <!-- <li><a href="#"><i class="zmdi zmdi-email-open"></i>Inbox</a></li> -->
                                                    
                                                </ul>
                                                <ul>
                                                   <!--  <li><a href="#"><i class="zmdi zmdi-settings"></i>Setting</a></li> -->
                                                    <li><a href="<?= base_url() ?>Login/logout"><i class="zmdi zmdi-lock-open"></i>Sing out</a></li>
                                                    <li><a href="<?= base_url('Login/changePassword') ?>"><i class="zmdi zmdi-key"></i>Change Password </a></li>
                                                </ul>
                                                <ul>
