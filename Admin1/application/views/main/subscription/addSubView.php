            ...
            <div class="row justify-content-between align-items-center mb-10">
                ...
                <div class="col-12 col-lg-auto mb-20">
                    <div class="page-heading">
                        <h3>Subscription <span>/ Add Subscription</span></h3>
                    </div>
                ...
                <div class="col-lg-12 col-12 mb-30">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form action="<?= base_url('Subscription/addSubscription') ?>" method="post" enctype='multipart/form-data'>
                                <div class="row mbn-20">

                                    <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Subscription Name</label>
                                        <input type="text" id="formLayoutUsername1" name="sub_name" class="form-control" placeholder="Subscription Name" required>
                                    </div>
                                    
                                    
                                     <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Hours</label>
                                        <input type="number" name="sub_hours" class="form-control" placeholder="Hours">
                                    </div>
                                    
                                     <div class="col-6 mb-20">
                                        <label for="formLayoutUsername1">Validity In Month</label>
                                        <input type="number" id="formLayoutUsername1" name="sub_validity" class="form-control" placeholder="Validity In Month">
                                    </div>
                                    ...
                                    <div class="col-4 mb-20">
                                        ...
                                        <input type="number" id="formLayoutMessage2" name="sub_price" class="form-control" placeholder="Price" >
                                    </div>
